...
def handle_customer_choices(customer_choices, customers):
    ...
    # Edit a Customer
        ...
        if customers.selected_customer:
            display(LINE)
            print(f"Let's update the customer {customers.selected_customer}")
...
def handle_video_choices(video_choices, videos):
    ...
    # See information for one Video
        ...
        if videos.selected_video:
            ...
            display(LINE)
            print("Could not find video by that title or id")
    ...
    # Add a new Video     
        ...
        display(LINE)
        print("Successfully added new video")
    ...
    # Edit a Customer
        ...
        if videos.selected_video:
            display(LINE)
            print(f"Let's update the video {videos.selected_video}")
